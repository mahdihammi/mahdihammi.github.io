    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="members.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="overflow:hidden">Message</th>
                             ...
                             <?php
                                 if ($result->num_rows > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $members['subject'] ?></td>
                                        <td><?php echo $members['message'] ?></td>
                                        <td class="d-flex"><a class="btn btn-danger mx-3" href="deletemessage.php?id=<?php echo $members['id']; ?>">Delete</a><a class="btn btn-success" href="update.php?id=<?php echo $members['id']; ?>">update</a></td>
